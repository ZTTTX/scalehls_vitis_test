...
set portList { 
	...
	{ l_sum_0_din sc_out sc_lv 64 signal 1 } 
	{ l_sum_0_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ l_sum_0_fifo_cap sc_in sc_lv 2 signal 1 } 
	{ l_sum_0_full_n sc_in sc_logic 1 signal 1 } 
	{ l_sum_0_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_7_full_dsp_1_U62", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_7_full_dsp_1_U63", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_5_no_dsp_1_U64", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "5148", "Max" : "5148"}
	, {"Name" : "Interval", "Min" : "5148", "Max" : "5148"}
]}
...
set Spec2ImplPortList { 
	...
	l_sum_0 { ap_fifo {  { l_sum_0_din fifo_port_we 1 64 }  { l_sum_0_num_data_valid fifo_status_num_data_valid 0 2 }  { l_sum_0_fifo_cap fifo_update 0 2 }  { l_sum_0_full_n fifo_status 0 1 }  { l_sum_0_write fifo_data 1 1 } } }
}
