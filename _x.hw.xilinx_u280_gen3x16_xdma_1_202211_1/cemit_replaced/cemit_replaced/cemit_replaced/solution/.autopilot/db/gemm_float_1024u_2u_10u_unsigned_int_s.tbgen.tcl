...
set C_modelArgList {
	...
	{ l_strSum7_i int 64 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "l_strA4_i", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "l_strSum7_i", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ l_strC6_i_dout sc_in sc_lv 64 signal 2 } 
	{ l_strC6_i_empty_n sc_in sc_logic 1 signal 2 } 
	{ l_strC6_i_read sc_out sc_logic 1 signal 2 } 
	{ l_strSum7_i_din sc_out sc_lv 64 signal 3 } 
	{ l_strSum7_i_full_n sc_in sc_logic 1 signal 3 } 
	{ l_strSum7_i_write sc_out sc_logic 1 signal 3 } 
...
set NewPortList {[ 
	{ "name": "l_strA4_i_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "l_strA4_i", "role": "dout" }} , 
 	...
 	{ "name": "l_strSum7_i_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "l_strSum7_i", "role": "din" }} , 
 	{ "name": "l_strSum7_i_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "l_strSum7_i", "role": "full_n" }} , 
 	{ "name": "l_strSum7_i_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "l_strSum7_i", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "69", "76", "80", "84", "85", "86", "87", "88"],
		...
		"Port" : [
			{"Name" : "l_strA4_i", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "gemm_U0", "Port" : "l_strA4_i"}]},
			{"Name" : "l_strB5_i", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "gemm_U0", "Port" : "l_strB5_i"}]},
			{"Name" : "l_strC6_i", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "76", "SubInstance" : "scal_float_2u_unsigned_int_U0", "Port" : "l_strC6_i"}]},
			{"Name" : "l_strSum7_i", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "80", "SubInstance" : "axpy_float_2u_unsigned_int_U0", "Port" : "l_strSum7_i"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.gemm_U0", "Parent" : "0", "Child" : ["2"],
		...
		"Port" : [
			{"Name" : "l_strA4_i", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "process_U0", "Port" : "l_strA4_i"}]},
			{"Name" : "l_strB5_i", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "process_U0", "Port" : "l_strB5_i"}]},
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.gemm_U0.process_U0", "Parent" : "1", "Child" : ["3", "8", "15", "35", "55", "57", "58", "59", "60", "61", "62", "63", "64", "65", "66", "67", "68"],
		...
		"Port" : [
			{"Name" : "l_strA4_i", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "tagAB_U0", "Port" : "l_strA4_i"}]},
			{"Name" : "l_strB5_i", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "tagAB_U0", "Port" : "l_strB5_i"}]},
			{"Name" : "l_sum3", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["69"], "DependentChan" : "84", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
	...
	{"ID" : "3", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.gemm_U0.process_U0.tagAB_U0", "Parent" : "2", "Child" : ["4", "6"],
		...
		"Port" : [
			{"Name" : "l_strA4_i", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_tagAB_Pipeline_VITIS_LOOP_271_1_VITIS_LOOP_272_2_fu_24", "Port" : "l_strA4_i", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "l_strB5_i", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_tagAB_Pipeline_VITIS_LOOP_271_1_VITIS_LOOP_272_2_fu_24", "Port" : "l_strB5_i", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
	...
	{"ID" : "25", "Level" : "6", "Path" : "`AUTOTB_DUT_INST.gemm_U0.process_U0.macs_U0.muls_U0.grp_muls_Pipeline_VITIS_LOOP_101_2_fu_54.fmul_32ns_32ns_32_4_max_dsp_1_U30", "Parent" : "24"},
	{"ID" : "26", "Level" : "6", "Path" : "`AUTOTB_DUT_INST.gemm_U0.process_U0.macs_U0.muls_U0.grp_muls_Pipeline_VITIS_LOOP_101_2_fu_54.fmul_32ns_32ns_32_4_max_dsp_1_U31", "Parent" : "24"},
	...
	{"ID" : "29", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.gemm_U0.process_U0.macs_U0.adds_U0.fadd_32ns_32ns_32_7_full_dsp_1_U46", "Parent" : "28"},
	{"ID" : "30", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.gemm_U0.process_U0.macs_U0.adds_U0.fadd_32ns_32ns_32_7_full_dsp_1_U47", "Parent" : "28"},
	{"ID" : "31", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.gemm_U0.process_U0.macs_U0.adds_U0.fadd_32ns_32ns_32_5_no_dsp_1_U48", "Parent" : "28"},
	...
	{"ID" : "44", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.gemm_U0.process_U0.macs_1_U0.muls_2_U0.grp_muls_2_Pipeline_VITIS_LOOP_153_2_fu_52", "Parent" : "36", "Child" : ["45", "46", "47"],
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_153_2", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter5", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter5", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "45", "Level" : "6", "Path" : "`AUTOTB_DUT_INST.gemm_U0.process_U0.macs_1_U0.muls_2_U0.grp_muls_2_Pipeline_VITIS_LOOP_153_2_fu_52.fmul_32ns_32ns_32_4_max_dsp_1_U62", "Parent" : "44"},
	{"ID" : "46", "Level" : "6", "Path" : "`AUTOTB_DUT_INST.gemm_U0.process_U0.macs_1_U0.muls_2_U0.grp_muls_2_Pipeline_VITIS_LOOP_153_2_fu_52.fmul_32ns_32ns_32_4_max_dsp_1_U63", "Parent" : "44"},
	...
	{"ID" : "48", "Level" : "4", "Path" : "`AUTOTB_DUT_INST.gemm_U0.process_U0.macs_1_U0.adds_3_U0", "Parent" : "35", "Child" : ["49", "50", "51", "52"],
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_193_1_VITIS_LOOP_194_2", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "4", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage2", "LastStateIter" : "ap_enable_reg_pp0_iter7", "LastStateBlock" : "ap_block_pp0_stage2_subdone", "QuitState" : "ap_ST_fsm_pp0_stage2", "QuitStateIter" : "ap_enable_reg_pp0_iter7", "QuitStateBlock" : "ap_block_pp0_stage2_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "1"}}]},
	{"ID" : "49", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.gemm_U0.process_U0.macs_1_U0.adds_3_U0.fadd_32ns_32ns_32_7_full_dsp_1_U75", "Parent" : "48"},
	{"ID" : "50", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.gemm_U0.process_U0.macs_1_U0.adds_3_U0.fadd_32ns_32ns_32_7_full_dsp_1_U76", "Parent" : "48"},
	{"ID" : "51", "Level" : "5", "Path" : "`AUTOTB_DUT_INST.gemm_U0.process_U0.macs_1_U0.adds_3_U0.fadd_32ns_32ns_32_5_no_dsp_1_U77", "Parent" : "48"},
	...
	{"ID" : "69", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.gemmBufferC_float_2u_2u_10u_U0", "Parent" : "0", "Child" : ["70", "71", "72", "74"],
		...
		"Port" : [
			{"Name" : "l_sum3", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["1","2","55"], "DependentChan" : "84", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "72", "SubInstance" : "grp_gemmBufferC_float_2u_2u_10u_Pipeline_VITIS_LOOP_93_1_VITIS_LOOP_94_2_fu_30", "Port" : "l_sum3", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "l_mat4", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["80"], "DependentChan" : "85", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "74", "SubInstance" : "grp_gemmBufferC_float_2u_2u_10u_Pipeline_VITIS_LOOP_119_8_fu_40", "Port" : "l_mat4", "Inst_start_state" : "4", "Inst_end_state" : "5"}]}]},
	...
	{"ID" : "72", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.gemmBufferC_float_2u_2u_10u_U0.grp_gemmBufferC_float_2u_2u_10u_Pipeline_VITIS_LOOP_93_1_VITIS_LOOP_94_2_fu_30", "Parent" : "69", "Child" : ["73"],
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_93_1_VITIS_LOOP_94_2", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter1", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter0", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "73", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.gemmBufferC_float_2u_2u_10u_U0.grp_gemmBufferC_float_2u_2u_10u_Pipeline_VITIS_LOOP_93_1_VITIS_LOOP_94_2_fu_30.flow_control_loop_pipe_sequential_init_U", "Parent" : "72"},
	{"ID" : "74", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.gemmBufferC_float_2u_2u_10u_U0.grp_gemmBufferC_float_2u_2u_10u_Pipeline_VITIS_LOOP_119_8_fu_40", "Parent" : "69", "Child" : ["75"],
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_119_8", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter1", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter0", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
	{"ID" : "75", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.gemmBufferC_float_2u_2u_10u_U0.grp_gemmBufferC_float_2u_2u_10u_Pipeline_VITIS_LOOP_119_8_fu_40.flow_control_loop_pipe_sequential_init_U", "Parent" : "74"},
	...
	{"ID" : "77", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.scal_float_2u_unsigned_int_U0.fmul_32ns_32ns_32_4_max_dsp_1_U115", "Parent" : "76"},
	{"ID" : "78", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.scal_float_2u_unsigned_int_U0.fmul_32ns_32ns_32_4_max_dsp_1_U116", "Parent" : "76"},
	...
	{"ID" : "80", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.axpy_float_2u_unsigned_int_U0", "Parent" : "0", "Child" : ["81", "82", "83"],
		...
		"Port" : [
			...
			{"Name" : "l_strSum7_i", "Type" : "Fifo", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "l_strSum7_i_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "VITIS_LOOP_62_1", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "1", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage0", "LastStateIter" : "ap_enable_reg_pp0_iter9", "LastStateBlock" : "ap_block_pp0_stage0_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter9", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "1"}}]},
	{"ID" : "81", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.axpy_float_2u_unsigned_int_U0.fadd_32ns_32ns_32_7_full_dsp_1_U119", "Parent" : "80"},
	{"ID" : "82", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.axpy_float_2u_unsigned_int_U0.fadd_32ns_32ns_32_7_full_dsp_1_U120", "Parent" : "80"},
...
set ArgLastReadFirstWriteLatency {
	gemm_float_1024u_2u_10u_unsigned_int_s {
		...
		l_strSum7_i {Type O LastRead -1 FirstWrite 9}}
	gemm {
		l_strA4_i {Type I LastRead 1 FirstWrite -1}
		l_strB5_i {Type I LastRead 1 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	l_strSum7_i { ap_fifo {  { l_strSum7_i_din fifo_port_we 1 64 }  { l_strSum7_i_full_n fifo_status 0 1 }  { l_strSum7_i_write fifo_data 1 1 } } }
}
