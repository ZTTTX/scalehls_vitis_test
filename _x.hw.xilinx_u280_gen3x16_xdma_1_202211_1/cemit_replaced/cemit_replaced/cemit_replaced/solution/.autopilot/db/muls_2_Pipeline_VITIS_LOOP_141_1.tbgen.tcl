set moduleName muls_2_Pipeline_VITIS_LOOP_141_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {muls.2_Pipeline_VITIS_LOOP_141_1}
...
set portList { 
	...
	{ l_flush_Array_address0 sc_out sc_lv 1 signal 0 } 
	{ l_flush_Array_ce0 sc_out sc_logic 1 signal 0 } 
	{ l_flush_Array_we0 sc_out sc_logic 1 signal 0 } 
	{ l_flush_Array_d0 sc_out sc_lv 1 signal 0 } 
	{ l_flush_Array_q0 sc_in sc_lv 1 signal 0 } 
}
set NewPortList {[ 
