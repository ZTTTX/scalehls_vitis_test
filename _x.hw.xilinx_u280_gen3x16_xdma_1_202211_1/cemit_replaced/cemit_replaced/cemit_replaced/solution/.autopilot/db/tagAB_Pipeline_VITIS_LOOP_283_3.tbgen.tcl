set moduleName tagAB_Pipeline_VITIS_LOOP_283_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {tagAB_Pipeline_VITIS_LOOP_283_3}
...
set portList { 
	...
	{ l_aStr1_din sc_out sc_lv 66 signal 0 } 
	{ l_aStr1_num_data_valid sc_in sc_lv 2 signal 0 } 
	{ l_aStr1_fifo_cap sc_in sc_lv 2 signal 0 } 
	{ l_aStr1_full_n sc_in sc_logic 1 signal 0 } 
	{ l_aStr1_write sc_out sc_logic 1 signal 0 } 
	{ l_bStr2_din sc_out sc_lv 64 signal 1 } 
	{ l_bStr2_num_data_valid sc_in sc_lv 2 signal 1 } 
	{ l_bStr2_fifo_cap sc_in sc_lv 2 signal 1 } 
	{ l_bStr2_full_n sc_in sc_logic 1 signal 1 } 
	{ l_bStr2_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
