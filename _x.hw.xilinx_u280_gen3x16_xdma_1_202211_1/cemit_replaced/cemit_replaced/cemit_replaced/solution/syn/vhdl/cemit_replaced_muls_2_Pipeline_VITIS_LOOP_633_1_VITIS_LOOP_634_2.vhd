...
entity cemit_replaced_muls_2_Pipeline_VITIS_LOOP_633_1_VITIS_LOOP_634_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of cemit_replaced_muls_2_Pipeline_VITIS_LOOP_633_1_VITIS_LOOP_634_2 is 
...
attribute shreg_extract : string;
    ...
    signal col_7_fu_158_p3 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_col_6 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal add_ln633_2_fu_99_p2 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    ...
    add_ln633_2_fu_99_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten_load) + unsigned(ap_const_lv3_1));
    add_ln633_fu_108_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_row_load) + unsigned(ap_const_lv2_1));
    add_ln634_fu_152_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_col_6) + unsigned(ap_const_lv2_1));
    ...
    ap_sig_allocacmp_col_6_assign_proc : process(ap_CS_fsm_state1, col_fu_44, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_sig_allocacmp_col_6 <= ap_const_lv2_0;
        else 
    ...
    icmp_ln634_fu_114_p2 <= "1" when (ap_sig_allocacmp_col_6 = ap_const_lv2_2) else "0";
    l_Tc_m_Sreg_Array_1_address0 <= ap_const_lv64_0(1 - 1 downto 0);

    l_Tc_m_Sreg_Array_1_ce0_assign_proc : process(ap_CS_fsm_state1, icmp_ln633_fu_93_p2, trunc_ln633_fu_128_p1, ap_start_int)
    begin
    ...
    l_Tc_m_Sreg_Array_1_d0 <= ap_const_lv32_0;

    l_Tc_m_Sreg_Array_1_we0_assign_proc : process(ap_CS_fsm_state1, icmp_ln633_fu_93_p2, trunc_ln633_fu_128_p1, ap_start_int)
    begin
        if (((trunc_ln633_fu_128_p1 = ap_const_lv1_1) and (icmp_ln633_fu_93_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then 
    ...
    l_Tc_m_Sreg_Array_ce0_assign_proc : process(ap_CS_fsm_state1, icmp_ln633_fu_93_p2, trunc_ln633_fu_128_p1, ap_start_int)
    begin
    ...
    l_Tc_m_Sreg_Array_d0 <= ap_const_lv32_0;

    l_Tc_m_Sreg_Array_we0_assign_proc : process(ap_CS_fsm_state1, icmp_ln633_fu_93_p2, trunc_ln633_fu_128_p1, ap_start_int)
    begin
        if (((trunc_ln633_fu_128_p1 = ap_const_lv1_0) and (icmp_ln633_fu_93_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then 
