...
HD_PWD='/mnt/shared/home/tz32/scalehls_vitis_test/_x.hw.xilinx_u280_gen3x16_xdma_1_202211_1/cemit_replaced/cemit_replaced'
cd "$HD_PWD"
...
EAStep vitis_hls -f cemit_replaced.tcl -messageDb vitis_hls.pb
