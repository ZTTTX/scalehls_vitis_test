...
set_top forward
# v++ -g, -D, -I, --advanced.prop kernel.forward.kernel_flags
add_files "/mnt/shared/home/tz32/scalehls_vitis_test/src/forward.cpp" -cflags " -I /mnt/shared/home/tz32/scalehls_vitis_test/src"
...
config_export -format xo -ipname forward
csynth_design
export_design
close_project
