; ModuleID = '/mnt/shared/home/tz32/scalehls_vitis_test/_x.hw.xilinx_u280_gen3x16_xdma_1_202211_1/forward/forward/forward/solution/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_forward_ir([1 x [32 x [32 x float]]]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1" %v25, [10 x float]* noalias nocapture nonnull "fpga.decayed.dim.hint"="1" %v26, [10 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1024" %v27) local_unnamed_addr #0 {
entry:
  %malloccall = tail call i8* @malloc(i64 4096)
  %v25_copy = bitcast i8* %malloccall to [1 x [1 x [32 x [32 x float]]]]*
  %v26_copy = alloca [1 x [10 x float]], align 512
  %malloccall1 = tail call i8* @malloc(i64 40960)
  %v27_copy = bitcast i8* %malloccall1 to [1024 x [10 x float]]*
  %0 = bitcast [1 x [32 x [32 x float]]]* %v25 to [1 x [1 x [32 x [32 x float]]]]*
  %1 = bitcast [10 x float]* %v26 to [1 x [10 x float]]*
  %2 = bitcast [10 x float]* %v27 to [1024 x [10 x float]]*
  call fastcc void @copy_in([1 x [1 x [32 x [32 x float]]]]* nonnull %0, [1 x [1 x [32 x [32 x float]]]]* %v25_copy, [1 x [10 x float]]* nonnull %1, [1 x [10 x float]]* nonnull align 512 %v26_copy, [1024 x [10 x float]]* nonnull %2, [1024 x [10 x float]]* %v27_copy)
  %3 = getelementptr inbounds [1 x [1 x [32 x [32 x float]]]], [1 x [1 x [32 x [32 x float]]]]* %v25_copy, i32 0, i32 0
  %4 = getelementptr inbounds [1 x [10 x float]], [1 x [10 x float]]* %v26_copy, i32 0, i32 0
  %5 = getelementptr inbounds [1024 x [10 x float]], [1024 x [10 x float]]* %v27_copy, i32 0, i32 0
  call void @apatb_forward_hw([1 x [32 x [32 x float]]]* %3, [10 x float]* %4, [10 x float]* %5)
  call void @copy_back([1 x [1 x [32 x [32 x float]]]]* %0, [1 x [1 x [32 x [32 x float]]]]* %v25_copy, [1 x [10 x float]]* %1, [1 x [10 x float]]* %v26_copy, [1024 x [10 x float]]* %2, [1024 x [10 x float]]* %v27_copy)
...
declare void @apatb_forward_hw([1 x [32 x [32 x float]]]*, [10 x float]*, [10 x float]*)
...
define void @forward_hw_stub_wrapper([1 x [32 x [32 x float]]]*, [10 x float]*, [10 x float]*) #4 {
entry:
  ...
  call void @forward_hw_stub([1 x [32 x [32 x float]]]* %6, [10 x float]* %7, [10 x float]* %8)
...
declare void @forward_hw_stub([1 x [32 x [32 x float]]]*, [10 x float]*, [10 x float]*)
