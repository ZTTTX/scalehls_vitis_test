set moduleName forward_Pipeline_VITIS_LOOP_26_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {forward_Pipeline_VITIS_LOOP_26_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 64 regular {axi_master 1}  }
	{ sext_ln26 int 61 regular  }
	{ v30 float 32 regular {array 10 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "v25","offset": { "type": "dynamic","port_name": "v25","bundle": "ctrl"},"direction": "READONLY"},{"cName": "v26","offset": { "type": "dynamic","port_name": "v26","bundle": "ctrl"},"direction": "WRITEONLY"},{"cName": "v27","offset": { "type": "dynamic","port_name": "v27","bundle": "ctrl"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln26", "interface" : "wire", "bitwidth" : 61, "direction" : "READONLY"} , 
 	{ "Name" : "v30", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln26 sc_in sc_lv 61 signal 1 } 
	{ v30_address0 sc_out sc_lv 4 signal 2 } 
	{ v30_ce0 sc_out sc_logic 1 signal 2 } 
	{ v30_q0 sc_in sc_lv 32 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln26", "direction": "in", "datatype": "sc_lv", "bitwidth":61, "type": "signal", "bundle":{"name": "sext_ln26", "role": "default" }} , 
 	{ "name": "v30_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "v30", "role": "address0" }} , 
 	{ "name": "v30_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v30", "role": "ce0" }} , 
 	{ "name": "v30_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v30", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln26 { ap_none {  { sext_ln26 in_data 0 61 } } }
	v30 { ap_memory {  { v30_address0 mem_address 1 4 }  { v30_ce0 mem_ce 1 1 }  { v30_q0 mem_dout 0 32 } } }
}
