set moduleName forward_Pipeline_VITIS_LOOP_60_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {forward_Pipeline_VITIS_LOOP_60_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 64 regular {axi_master 0}  }
	{ v29 float 32 regular {array 1024 { 0 3 } 0 1 }  }
	{ v25 int 64 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "v25","offset": { "type": "dynamic","port_name": "v25","bundle": "ctrl"},"direction": "READONLY"},{"cName": "v26","offset": { "type": "dynamic","port_name": "v26","bundle": "ctrl"},"direction": "WRITEONLY"},{"cName": "v27","offset": { "type": "dynamic","port_name": "v27","bundle": "ctrl"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "v29", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "v25", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ v29_address0 sc_out sc_lv 10 signal 1 } 
	{ v29_ce0 sc_out sc_logic 1 signal 1 } 
	{ v29_we0 sc_out sc_logic 1 signal 1 } 
	{ v29_d0 sc_out sc_lv 32 signal 1 } 
	{ v25 sc_in sc_lv 64 signal 2 } 
	{ trunc_ln sc_in sc_lv 3 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "v29_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v29", "role": "we0" }} , 
 	{ "name": "v29_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "v29", "role": "d0" }} , 
 	{ "name": "v25", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v25", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1097", "Max" : "1097"}
	, {"Name" : "Interval", "Min" : "1097", "Max" : "1097"}
]}
...
set Spec2ImplPortList { 
	...
	v29 { ap_memory {  { v29_address0 mem_address 1 10 }  { v29_ce0 mem_ce 1 1 }  { v29_we0 mem_we 1 1 }  { v29_d0 mem_din 1 32 } } }
	v25 { ap_none {  { v25 in_data 0 64 } } }
