...
HLS_SOURCES = ../../../../src/test.cpp ../../../../src/largeNet_3_df.cpp
...
$(ObjDir)/largeNet_3_df.o: ../../../../src/largeNet_3_df.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../src/largeNet_3_df.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
...
-include $(ObjDir)/largeNet_3_df.d
