...
$(TEMP_DIR)/$(TOP_FUNC_NAME).xo: src/$(TOP_FUNC_NAME).cpp
	mkdir -p $(TEMP_DIR)
	v++ -c $(VPP_FLAGS) -t $(TARGET) --platform $(PLATFORM) -k $(TOP_FUNC_NAME) --temp_dir $(TEMP_DIR)  -I'$(<D)' -o'$@' '$<'
...
$(BUILD_DIR)/$(TOP_FUNC_NAME).xclbin: $(TEMP_DIR)/$(TOP_FUNC_NAME).xo
	...
	v++ -p $(LINK_OUTPUT) $(VPP_FLAGS) -t $(TARGET) --platform $(PLATFORM) --package.out_dir $(PACKAGE_OUT) -o $(BUILD_DIR)/$(TOP_FUNC_NAME).xclbin
